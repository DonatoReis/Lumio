// Esta é a implementação modificada da função findUserByEmail
// Copie e cole isso para substituir a função existente em src/hooks/useConversations.ts

// Adicione este import no topo do arquivo
import { isCompleteEmail } from '@/utils/validation';

// Improved findUserByEmail function with direct database query instead of Edge Function
